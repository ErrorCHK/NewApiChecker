...
//================= [ PROXY ] =================//
$curl = curl_init('http://ipv4.webshare.io/'); curl_setopt($curl, CURLOPT_PROXY, 'proxy.proxyverse.io:9200'); 
curl_setopt($curl, CURLOPT_PROXYUSERPWD, 'country-worldwide:b7f7abba-0914-43e0-9e2a-490413cda784'); curl_exec($curl);
