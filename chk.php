...
//================= [ PROXY ] =================//
$curl = curl_init('http://ipv4.webshare.io/'); curl_setopt($curl, CURLOPT_PROXY, '172.65.64.100:6060'); 
curl_setopt($curl, CURLOPT_PROXYUSERPWD, 'tqz0kumxn6c00pt:3vxwpufeky6t8xa'); curl_exec($curl);
